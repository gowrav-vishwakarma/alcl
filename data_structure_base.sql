...
--
-- Host: localhost
-- Generation Time: Apr 05, 2013 at 09:06 AM
...
CREATE TABLE IF NOT EXISTS `jos_xbvreward` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT AUTO_INCREMENT=618 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=277891 ;
...
CREATE TABLE IF NOT EXISTS `jos_xclosingsession` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1375490 ;
...
CREATE TABLE IF NOT EXISTS `jos_xlegs` (
  ...
  `TotalCount` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4377 ;
...
CREATE TABLE IF NOT EXISTS `jos_xpersonaldetails` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4421 ;
...
CREATE TABLE IF NOT EXISTS `jos_xpinmaster` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Pin` (`Pin`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=111560 ;
...
CREATE TABLE IF NOT EXISTS `jos_xpintransaction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT AUTO_INCREMENT=1461 ;
...
CREATE TABLE IF NOT EXISTS `jos_xspecialreward` (
  ...
  `period` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT AUTO_INCREMENT=4366 ;
...
CREATE TABLE IF NOT EXISTS `jos_xtreedetails` (
  ...
  PRIMARY KEY (`id`),
  KEY `Path` (`Path`(255))
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=111495 ;
...
CREATE TABLE IF NOT EXISTS `jos_xxkittransfers` (
  ...
  `pos_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT AUTO_INCREMENT=13053 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT AUTO_INCREMENT=4328 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT AUTO_INCREMENT=45302 ;
